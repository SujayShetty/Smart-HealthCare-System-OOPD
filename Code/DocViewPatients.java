...
public class DocViewPatients {
	 ...
	 */
			...
			public void runAdminViewPat(String docID) {
				try {
					DocViewPatients window = new DocViewPatients(docID);
	 ...
	 */
			 ...
			 */
	public DocViewPatients(String docID) {
		initialize(docID);
	}

	public DocViewPatients() {
